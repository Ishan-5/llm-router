...
const PICKS = {
  overall: [
    ...
    { model: 'deepseek-v4-flash', provider: 'openrouter', why: 'Top-tier performance at budget pricing. Punches well above its price.' },
    { model: 'openai/gpt-oss-120b', provider: 'groq', why: 'Best open-weight option on Groq. Runs fast on LPU infrastructure.' },
  ],
  coding: [
    { model: 'deepseek-v4-pro', provider: 'deepseek', why: 'Rivals frontier models on code benchmarks at a fraction of the price.' },
    { model: 'claude-3.5-sonnet', provider: 'anthropic', why: 'Excellent at complex refactoring, debugging, and code review.' },
    { model: 'codestral-latest', provider: 'mistral', why: 'Purpose-built for code. Fast inference on Mistral\'s API.' },
    { model: 'openai/gpt-oss-120b', provider: 'groq', why: 'Strong code generation, cheap tokens via Groq.' },
    { model: 'qwen/qwen3.6-27b', provider: 'groq', why: 'Open-source coder with strong multi-language support.' },
  ],
  writing: [
    ...
    { model: 'mistral-large-3', provider: 'mistral', why: 'Strong multilingual creative writing. Good at structured content.' },
    { model: 'openai/gpt-oss-120b', provider: 'groq', why: 'Strong open-weight option for creative tasks. Good at following style instructions.' },
  ],
  fast: [
  ...
  reasoning: [
    ...
    { model: 'openai/gpt-oss-120b', provider: 'groq', why: 'Best open-weight reasoning on Groq. Strong at math and logic.' },
  ],
}
...
const PROVIDER_COLORS = {
  ...
  openrouter: 'text-primary border-line bg-panel',
