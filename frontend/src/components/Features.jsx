const FEATURES = [
  ...
  },
  {
    ...
    title: 'Route from your terminal',
    body: 'The routewise npm CLI brings routing, streaming chat, analytics, and BYOM to your shell — one install, zero browser needed.',
  },
  {
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-cool">
