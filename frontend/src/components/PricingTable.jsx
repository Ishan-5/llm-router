                ...
                <table className="w-full text-xs font-mono">
                  <thead>
                    <tr className="border-b border-line bg-panel">
                      <th className="text-left px-4 py-3 text-muted font-normal">Model</th>
                      <th className="text-right px-4 py-3 text-muted font-normal">Input / 1M</th>
                      <th className="text-right px-4 py-3 text-muted font-normal">Output / 1M</th>
                      <th className="text-left px-4 py-3 text-muted font-normal hidden md:table-cell">Notes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {grouped[provider].map((row, i) => (
                      <tr key={row.model_id} className={`border-b border-line last:border-0 ${i % 2 === 0 ? '' : 'bg-panel/50'}`}>
